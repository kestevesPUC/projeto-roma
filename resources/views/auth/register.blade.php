...
{{--        </div>--}}
        ...
        <div class="mt-4">
            ...
            <x-text-input id="cpf" class="block mt-1 w-full cpfcnpj" type="text" name="cpf" :value="old('cpf')" required autofocus autocomplete="username" />
